...
urlpatterns = [
    ...
    path('usuarios/resetear-password/<int:usuario_id>/', login_required(views.resetear_contrasena_usuario), name='resetear_contrasena_usuario'),
    ...
    path('inventarios/movimiento/', login_required(views.registrar_movimiento_inventario), name='registrar_movimiento'),
    path('inventarios/historial/', login_required(views.historial_movimientos), name='historial_movimientos'),
    path('inventarios/historial/<int:inventario_id>/', login_required(views.historial_movimientos), name='historial_movimientos_producto'),
    path('inventarios/alertas/', login_required(views.alertas_inventario), name='alertas_inventario'),
    path('inventarios/exportar-excel/', login_required(views.exportar_inventario_excel), name='exportar_inventario_excel'),
    path('inventarios/exportar-movimientos/', login_required(views.exportar_movimientos_excel), name='exportar_movimientos_excel'),
